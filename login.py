...
#clase que contiene El login y los terminos y condiciones de la aplicacion
class LoginWindow(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Login")
        #Alto y ancho de la ventana o dimensiones 
...
class Ventana(tk.Frame):
    ...
    def fNuevo(self):
        #funciones del boton agregar los datos a Lista 
    ...
    # validacion para agregar los datos a la lista 
...
#funcion que modifica los datos 
    ...
    # funcion que valida los cambios de los datos y los remplaza
